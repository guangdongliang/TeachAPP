...
import com.teach.activity.BaseActivity;
...
public class MainActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (i != null) {
			...
			System.out.println(path=HttpConstants.HTTP_REQUEST+"/"+path);
			Log.d(TAG, "uri.getPath: " + path);
		}
	...
	private void ppt2png(final String path) throws IOException {
        ...
        Thread a=new Thread(){
			...
			public void run() {
				...
				try {
					ppt = new SlideShow(new URL(path).openStream());
	...
	private class MyOnScaleGestureListener extends
		...
		public void onScaleEnd(ScaleGestureDetector detector) {
			...
			// NOTE: 瀵ゆ儼绻滄穱顔筋劀缂傗晜鏂侀崥搴″讲閼崇晫些閸斻劑妫舵０锟�
